...
X_train = np.load(r'D:\irimages\irholography\CNN\data_v9_far_field\split_data\train\cropped_X_train_intensity.npy')
...
regressor.save(r'D:\irimages\irholography\CNN\CNN_v11_far_field_a_n\intensity\up_scaled_intensity.h5')
