...
This data set is padded version for applying BPF later on
"""
...
def getTotalField(k, k_j, n, res, a, ps, pp, numSample, NA_in, NA_out, option):
    ...
    Etot, B = MSI.scatterednInnerField(MSI.lambDa, MSI.magk, MSI.n, MSI.rMag)
...
np.save(r'D:\irimages\irholography\CNN\data_v7_padded\B_data_imag', B_data_imag)